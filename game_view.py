...
from game_config.text_constants import TextConstants
from game_config.pop_objects_constants import PopConstants
from game_config.board_constants import BoardConstants
from game_objects.rectangle import import_rectangles
